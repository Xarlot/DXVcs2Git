...
<!--		<div class="header">
	...
	<xsl:template name="print-module">
		...
		<tr class="clickablerow" onclick="toggle('{$module.id}', 'img-{$module.id}')">
			<td style="width: 10px">
				<img id="img-{$module.id}" src="{$applicationPath}/images/minus.png" />
			</td>
			<td style="width: 16px">
				<xsl:choose>
	...
	<xsl:template name="print-module-error-list">
		...
		<tr id="{$module.id}" class="errorlist">
			<td></td>
			<td colspan="6">
					...
					<tbody>
						<xsl:for-each select=".//Messages/Message">
							...
							<tr class="clickablerow" onclick="toggle('{$module.id}-{$message.id}', 'img-{$module.id}-{$message.id}')">
								<td style="width: 10px">
									<img id="img-{$module.id}-{$message.id}" src="{$applicationPath}/images/minus.png" />
								</td>
								<td style="width: 16px">
									<xsl:choose>
